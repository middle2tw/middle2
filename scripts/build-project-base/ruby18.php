...
// 3. 把 /srv/code/images/lang-ruby18.tar.gz 解壓縮進 chroot 中
...
class Prebuilder
{
    ...
    public function main($req_file)
    {
        ...
        $project_file = '/tmp/project-ruby18-' . md5_file($req_file);
        ...
        error_log('untar ruby18.tar.gz...');
        // 把 ruby18 package 解進去
        system("tar zxf /srv/code/images/lang-ruby18.tar.gz --directory={$root}");
        ...
        // 安裝 ruby18 package
        passthru("/var/lib/gems/1.8/bin/bundle --gemfile=" . escapeshellarg($req_file) . " --path={$root}/usr/lib/");
