...
iptables -A INPUT -p tcp -s 210.61.2.65 --dport 3306 -j ACCEPT
iptables -A INPUT -p tcp -s 203.66.14.47 --dport 3306 -j ACCEPT
...
iptables -A INPUT -p tcp -s 210.61.2.65 --dport 9200 -j ACCEPT
iptables -A INPUT -p tcp -s 203.66.14.47 --dport 9200 -j ACCEPT
