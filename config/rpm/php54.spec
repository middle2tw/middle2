...
%build
%configure --enable-fpm --with-config-file-scan-dir=/etc/php.d/ --with-config-file-path=/etc --enable-mysqlnd --with-mysql --with-mysqli --with-zlib --with-gettext --enable-pcntl
make %{?_smp_mflags}
